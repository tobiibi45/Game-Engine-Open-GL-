...
GLfloat GLFW_EngineCore::lastX;
GLfloat GLFW_EngineCore::lastY;
GLfloat GLFW_EngineCore::m_xOffset;
GLfloat GLFW_EngineCore::m_yOffset;
bool GLFW_EngineCore::firstMouse;
bool GLFW_EngineCore::mouse_enter;
...
void GLFW_EngineCore::mouseenteredcallback(struct GLFWwindow* window, int enter)
{
	mouse_enter = enter != 0;
}
...
void GLFW_EngineCore::mousebuttoncallback(GLFWwindow* window, int button, int action, int mods)
{
...
void GLFW_EngineCore::do_movement()
{
